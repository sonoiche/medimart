        ...
        <ul class="navbar-nav navbar-align">
            ...
            <li class="nav-item dropdown">
                <a class="nav-icon pe-md-0 dropdown-toggle" href="#" data-bs-toggle="dropdown">
                    <img src="{{ url('assets/img/avatars/avatar.jpg') }}" class="avatar img-fluid rounded" alt="Charles Hall" />
                </a>
                <div class="dropdown-menu dropdown-menu-end">
                    <a class="dropdown-item" href="{{ url('account', auth()->user()->id) }}/edit"><i class="align-middle me-1" data-feather="user"></i> Edit Account</a>
